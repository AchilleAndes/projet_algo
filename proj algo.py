...
if variable1 == 'Temperature' or variable1 == 'temperature' or variable1 == 'Température' or variable1 == 'température':
    ...
    ax11 = plt.subplot(321)
    plt.subplot(321)
    ax11.plot(sent_at1, noise1, label='bruit 1', color = 'tab:red')
    ax11.tick_params(axis='y',  labelcolor = 'tab:red')
    ...
    ax12 = plt.subplot(322)
    plt.subplot(322)
    ax12.plot(sent_at2, noise2, label='bruit 2', color = 'tab:red')
    ax12.tick_params(axis='y',  labelcolor = 'tab:red')
    ...
    ax13 = plt.subplot(323)
    plt.subplot(323)
    ax13.plot(sent_at3, noise3, label='bruit 3', color = 'tab:red')
    ax13.tick_params(axis='y',  labelcolor = 'tab:red')
    ...
    ax14 = plt.subplot(324)
    plt.subplot(324)
    ax14.plot(sent_at4, noise4, label='bruit 4', color = 'tab:red')
    ax14.tick_params(axis='y',  labelcolor = 'tab:red')
    ...
    ax15 = plt.subplot(325)
    plt.subplot(325)
    ax15.plot(sent_at5, noise5, label='bruit 5', color = 'tab:red')
    ax15.tick_params(axis='y',  labelcolor = 'tab:red')
    ...
    ax16 = plt.subplot(326)
    plt.subplot(326)
    ax16.plot(sent_at6, noise6, label='bruit 6', color = 'tab:red')
    ax16.tick_params(axis='y',  labelcolor = 'tab:red')
...
if variable2 != None :
    if variable2 == 'Temperature' or variable2 == 'temperature' or variable2 == 'Température' or variable2 == 'température':
        ...
        plt.text(start_date, 7*(max(var12)-min(var12))/13 + min(var12), u"min bruit = %f"%(min(noise2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 6*(max(var12)-min(var12))/13 + min(var12), u"max bruit = %f"%(max(noise2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 5*(max(var12)-min(var12))/13 + min(var12), u"moy bruit = %f"%(moyenne(noise2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 4*(max(var12)-min(var12))/13 + min(var12), u"med bruit = %f"%(mediane(noise2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 3*(max(var12)-min(var12))/13 + min(var12), u"EcTyp bruit = %f"%(ecartType(noise2[s2:e2+1])), fontsize=7)
        plt.text(start_date, (max(var12)-min(var12))/13 + min(var12), u"coef corr = %f"%coefCorr(var12[s2:e2+1],var22[s2:e2+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(323)
        plt.plot(sent_at3, noise3, label='bruit 3')
        plt.text(start_date, 7*(max(var13)-min(var13))/13 + min(var13), u"min bruit = %f"%(min(noise3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 6*(max(var13)-min(var13))/13 + min(var13), u"max bruit = %f"%(max(noise3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 5*(max(var13)-min(var13))/13 + min(var13), u"moy bruit = %f"%(moyenne(noise3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 4*(max(var13)-min(var13))/13 + min(var13), u"med bruit = %f"%(mediane(noise3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 3*(max(var13)-min(var13))/13 + min(var13), u"EcTyp bruit = %f"%(ecartType(noise3[s3:e3+1])), fontsize=7)
        plt.text(start_date, (max(var13)-min(var13))/13 + min(var13), u"coef corr = %f"%coefCorr(var13[s3:e3+1],var23[s3:e3+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(324)
        ...
        plt.text(start_date, 4*(max(var14)-min(var14))/13 + min(var14), u"med bruit = %f"%(mediane(noise4[s4:e4+1])), fontsize=7)
        plt.text(start_date, 3*(max(var14)-min(var14))/13 + min(var14), u"EcTyp bruit = %f"%(ecartType(noise4[s4:e4+1])), fontsize=7)
        plt.text(start_date, (max(var14)-min(var14))/13 + min(var14), u"coef corr = %f"%coefCorr(var14[s4:e4+1],var24[s4:e4+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(325)
        plt.plot(sent_at5, noise5, label='bruit 5')
        plt.text(start_date, 7*(max(var15)-min(var15))/13 + min(var15), u"min bruit = %f"%(min(noise5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 6*(max(var15)-min(var15))/13 + min(var15), u"max bruit = %f"%(max(noise5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 5*(max(var15)-min(var15))/13 + min(var15), u"moy bruit = %f"%(moyenne(noise5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 4*(max(var15)-min(var15))/13 + min(var15), u"med bruit = %f"%(mediane(noise5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 3*(max(var15)-min(var15))/13 + min(var15), u"EcTyp bruit = %f"%(ecartType(noise5[s5:e5+1])), fontsize=7)
        plt.text(start_date, (max(var15)-min(var15))/13 + min(var15), u"coef corr = %f"%coefCorr(var15[s5:e5+1],var25[s5:e5+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(326)
        plt.plot(sent_at6, noise6, label='bruit 6')
        plt.text(start_date, 7*(max(var16)-min(var16))/13 + min(var16), u"min bruit = %f"%(min(noise6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 6*(max(var16)-min(var16))/13 + min(var16), u"max bruit = %f"%(max(noise6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 5*(max(var16)-min(var16))/13 + min(var16), u"moy bruit = %f"%(moyenne(noise6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 4*(max(var16)-min(var16))/13 + min(var16), u"med bruit = %f"%(mediane(noise6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 3*(max(var16)-min(var16))/13 + min(var16), u"EcTyp bruit = %f"%(ecartType(noise6[s6:e6+1])), fontsize=7)
        plt.text(start_date, (max(var16)-min(var16))/13 + min(var16), u"coef corr = %f"%coefCorr(var16[s6:e6+1],var26[s6:e6+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.show()
