...
if variable1 == 'Temperature' or variable1 == 'temperature' or variable1 == 'Température' or variable1 == 'température':
    ...
    plt.text(start_date, max(var11), u"min temp = %f"%(min(temperature1)), fontsize=7)
    plt.text(start_date, 12*(max(var11)-min(var11))/13 + min(var11), u"max temp = %f"%(max(temperature1)), fontsize=7)
    plt.text(start_date, 11*(max(var11)-min(var11))/13 + min(var11), u"moy temp = %f"%(moyenne(temperature1)), fontsize=7)
    plt.text(start_date, 10*(max(var11)-min(var11))/13 + min(var11), u"med temp = %f"%(mediane(temperature1)), fontsize=7)
    plt.text(start_date, 9*(max(var11)-min(var11))/13 + min(var11), u"EcTyp temp = %f"%(ecartType(temperature1)), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend()
    plt.subplot(322)
    plt.plot(sent_at2, temperature2, label='tem 2')
    plt.text(start_date, max(var12), u"min temp = %f"%(min(temperature2)), fontsize=7)
    plt.text(start_date, 12*(max(var12)-min(var12))/13 + min(var12), u"max temp = %f"%(max(temperature2)), fontsize=7)
    plt.text(start_date, 11*(max(var12)-min(var12))/13 + min(var12), u"moy temp = %f"%(moyenne(temperature2)), fontsize=7)
    plt.text(start_date, 10*(max(var12)-min(var12))/13 + min(var12), u"med temp = %f"%(mediane(temperature2)), fontsize=7)
    plt.text(start_date, 9*(max(var12)-min(var12))/13 + min(var12), u"EcTyp temp = %f"%(ecartType(temperature2)), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend()
    plt.subplot(323)
    plt.plot(sent_at3, temperature3, label='tem 3')
    plt.text(start_date, max(var13), u"min temp = %f"%(min(temperature3)), fontsize=7)
    plt.text(start_date, 12*(max(var13)-min(var13))/13 + min(var13), u"max temp = %f"%(max(temperature3)), fontsize=7)
    plt.text(start_date, 11*(max(var13)-min(var13))/13 + min(var13), u"moy temp = %f"%(moyenne(temperature3)), fontsize=7)
    plt.text(start_date, 10*(max(var13)-min(var13))/13 + min(var13), u"med temp = %f"%(mediane(temperature3)), fontsize=7)
    plt.text(start_date, 9*(max(var13)-min(var13))/13 + min(var13), u"EcTyp temp = %f"%(ecartType(temperature3)), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend()
    plt.subplot(324)
    plt.plot(sent_at4, temperature4, label='tem 4')
    plt.text(start_date, max(var14), u"min temp = %f"%(min(temperature4)), fontsize=7)
    plt.text(start_date, 12*(max(var14)-min(var14))/13 + min(var14), u"max temp = %f"%(max(temperature4)), fontsize=7)
    plt.text(start_date, 11*(max(var14)-min(var14))/13 + min(var14), u"moy temp = %f"%(moyenne(temperature4)), fontsize=7)
    plt.text(start_date, 10*(max(var14)-min(var14))/13 + min(var14), u"med temp = %f"%(mediane(temperature4)), fontsize=7)
    plt.text(start_date, 9*(max(var14)-min(var14))/13 + min(var14), u"EcTyp temp = %f"%(ecartType(temperature4)), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend()
    plt.subplot(325)
    plt.plot(sent_at5, temperature5, label='tem 5')
    plt.text(start_date, max(var15), u"min temp = %f"%(min(temperature5)), fontsize=7)
    plt.text(start_date, 12*(max(var15)-min(var15))/13 + min(var15), u"max temp = %f"%(max(temperature5)), fontsize=7)
    plt.text(start_date, 11*(max(var15)-min(var15))/13 + min(var15), u"moy temp = %f"%(moyenne(temperature5)), fontsize=7)
    plt.text(start_date, 10*(max(var15)-min(var15))/13 + min(var15), u"med temp = %f"%(mediane(temperature5)), fontsize=7)
    plt.text(start_date, 9*(max(var15)-min(var15))/13 + min(var15), u"EcTyp temp = %f"%(ecartType(temperature5)), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend()
    plt.subplot(326)
    plt.plot(sent_at6, temperature6, label='tem 6')
    plt.text(start_date, max(var16), u"min temp = %f"%(min(temperature6)), fontsize=7)
    plt.text(start_date, 12*(max(var16)-min(var16))/13 + min(var16), u"max temp = %f"%(max(temperature6)), fontsize=7)
    plt.text(start_date, 11*(max(var16)-min(var16))/13 + min(var16), u"moy temp = %f"%(moyenne(temperature6)), fontsize=7)
    plt.text(start_date, 10*(max(var16)-min(var16))/13 + min(var16), u"med temp = %f"%(mediane(temperature6)), fontsize=7)
    plt.text(start_date, 9*(max(var16)-min(var16))/13 + min(var16), u"EcTyp temp = %f"%(ecartType(temperature6)), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend()
    plt.show()
elif variable1 == 'bruit' or variable1 == 'Bruit':
...
if variable2 != None :
    if variable2 == 'Temperature' or variable2 == 'temperature' or variable2 == 'Température' or variable2 == 'température':
        plt.subplot(321)
        plt.plot(sent_at1, temperature1, label='tem 1')
        plt.text(start_date, 7*(max(var11)-min(var11))/13 + min(var11), u"min temp = %f"%(min(temperature1)), fontsize=7)
        plt.text(start_date, 6*(max(var11)-min(var11))/13 + min(var11), u"max temp = %f"%(max(temperature1)), fontsize=7)
        plt.text(start_date, 5*(max(var11)-min(var11))/13 + min(var11), u"moy temp = %f"%(moyenne(temperature1)), fontsize=7)
        plt.text(start_date, 4*(max(var11)-min(var11))/13 + min(var11), u"med temp = %f"%(mediane(temperature1)), fontsize=7)
        plt.text(start_date, 3*(max(var11)-min(var11))/13 + min(var11), u"EcTyp temp = %f"%(ecartType(temperature1)), fontsize=7)
        plt.text(start_date, (max(var11)-min(var11))/13 + min(var11), u"coef corr = %f"%coefCorr(var11,var21), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend()
        plt.subplot(322)
        plt.plot(sent_at2, temperature2, label='tem 2')
        plt.text(start_date, 7*(max(var12)-min(var12))/13 + min(var12), u"min temp = %f"%(min(temperature2)), fontsize=7)
        plt.text(start_date, 6*(max(var12)-min(var12))/13 + min(var12), u"max temp = %f"%(max(temperature2)), fontsize=7)
        plt.text(start_date, 5*(max(var12)-min(var12))/13 + min(var12), u"moy temp = %f"%(moyenne(temperature2)), fontsize=7)
        plt.text(start_date, 4*(max(var12)-min(var12))/13 + min(var12), u"med temp = %f"%(mediane(temperature2)), fontsize=7)
        plt.text(start_date, 3*(max(var12)-min(var12))/13 + min(var12), u"EcTyp temp = %f"%(ecartType(temperature2)), fontsize=7)
        plt.text(start_date, (max(var11)-min(var11))/13 + min(var11), u"coef corr = %f"%coefCorr(var12,var22), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend()
        plt.subplot(323)
        plt.plot(sent_at3, temperature3, label='tem 3')
        plt.text(start_date, 7*(max(var13)-min(var13))/13 + min(var13), u"min temp = %f"%(min(temperature3)), fontsize=7)
        plt.text(start_date, 6*(max(var13)-min(var13))/13 + min(var13), u"max temp = %f"%(max(temperature3)), fontsize=7)
        plt.text(start_date, 5*(max(var13)-min(var13))/13 + min(var13), u"moy temp = %f"%(moyenne(temperature3)), fontsize=7)
        plt.text(start_date, 4*(max(var13)-min(var13))/13 + min(var13), u"med temp = %f"%(mediane(temperature3)), fontsize=7)
        plt.text(start_date, 3*(max(var13)-min(var13))/13 + min(var13), u"EcTyp temp = %f"%(ecartType(temperature3)), fontsize=7)
        plt.text(start_date, (max(var11)-min(var11))/13 + min(var11), u"coef corr = %f"%coefCorr(var13,var23), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend()
        plt.subplot(324)
        plt.plot(sent_at4, temperature4, label='tem 4')
        plt.text(start_date, 7*(max(var14)-min(var14))/13 + min(var14), u"min temp = %f"%(min(temperature4)), fontsize=7)
        plt.text(start_date, 6*(max(var14)-min(var14))/13 + min(var14), u"max temp = %f"%(max(temperature4)), fontsize=7)
        plt.text(start_date, 5*(max(var14)-min(var14))/13 + min(var14), u"moy temp = %f"%(moyenne(temperature4)), fontsize=7)
        plt.text(start_date, 4*(max(var14)-min(var14))/13 + min(var14), u"med temp = %f"%(mediane(temperature4)), fontsize=7)
        plt.text(start_date, 3*(max(var14)-min(var14))/13 + min(var14), u"EcTyp temp = %f"%(ecartType(temperature4)), fontsize=7)
        plt.text(start_date, (max(var11)-min(var11))/13 + min(var11), u"coef corr = %f"%coefCorr(var14,var24), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend()
        plt.subplot(325)
        plt.plot(sent_at5, temperature5, label='tem 5')
        plt.text(start_date, 7*(max(var15)-min(var15))/13 + min(var15), u"min temp = %f"%(min(temperature5)), fontsize=7)
        plt.text(start_date, 6*(max(var15)-min(var15))/13 + min(var15), u"max temp = %f"%(max(temperature5)), fontsize=7)
        plt.text(start_date, 5*(max(var15)-min(var15))/13 + min(var15), u"moy temp = %f"%(moyenne(temperature5)), fontsize=7)
        plt.text(start_date, 4*(max(var15)-min(var15))/13 + min(var15), u"med temp = %f"%(mediane(temperature5)), fontsize=7)
        plt.text(start_date, 3*(max(var15)-min(var15))/13 + min(var15), u"EcTyp temp = %f"%(ecartType(temperature5)), fontsize=7)
        plt.text(start_date, (max(var11)-min(var11))/13 + min(var11), u"coef corr = %f"%coefCorr(var15,var25), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend()
        plt.subplot(326)
        plt.plot(sent_at6, temperature6, label='tem 6')
        plt.text(start_date, 7*(max(var16)-min(var16))/13 + min(var16), u"min temp = %f"%(min(temperature6)), fontsize=7)
        plt.text(start_date, 6*(max(var16)-min(var16))/13 + min(var16), u"max temp = %f"%(max(temperature6)), fontsize=7)
        plt.text(start_date, 5*(max(var16)-min(var16))/13 + min(var16), u"moy temp = %f"%(moyenne(temperature6)), fontsize=7)
        plt.text(start_date, 4*(max(var16)-min(var16))/13 + min(var16), u"med temp = %f"%(mediane(temperature6)), fontsize=7)
        plt.text(start_date, 3*(max(var16)-min(var16))/13 + min(var16), u"EcTyp temp = %f"%(ecartType(temperature6)), fontsize=7)
        plt.text(start_date, (max(var11)-min(var11))/13 + min(var11), u"coef corr = %f"%coefCorr(var16,var26), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend()
        plt.show()
    elif variable2 == 'bruit' or variable2 == 'Bruit':
