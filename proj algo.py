...
if variable1 == 'Temperature' or variable1 == 'temperature' or variable1 == 'Température' or variable1 == 'température':
    ...
    plt.subplot(322)
    ax12.plot(sent_at2, temperature2, label='tem 2', color = 'tab:red')
    ...
    plt.subplot(323)
    ax13.plot(sent_at3, temperature3, label='tem 3', color = 'tab:red')
    ax13.tick_params(axis='y',  labelcolor = 'tab:red')
    ...
    plt.subplot(324)
    ax14.plot(sent_at4, temperature4, label='tem 4', color = 'tab:red')
    ax14.tick_params(axis='y',  labelcolor = 'tab:red')
    ...
    plt.subplot(326)
    ax16.plot(sent_at6, temperature6, label='tem 6', color = 'tab:red')
    ax16.tick_params(axis='y',  labelcolor = 'tab:red')
    ...
    plt.text(start_date, max(var11), u"min noise = %f"%(min(noise1[s1:e1+1])), fontsize=7)
    plt.text(start_date, 12*(max(var11)-min(var11))/13 + min(var11), u"max noise = %f"%(max(noise1[s1:e1+1])), fontsize=7)
    plt.text(start_date, 11*(max(var11)-min(var11))/13 + min(var11), u"moy noise = %f"%(moyenne(noise1[s1:e1+1])), fontsize=7)
    plt.text(start_date, 10*(max(var11)-min(var11))/13 + min(var11), u"med noise = %f"%(mediane(noise1[s1:e1+1])), fontsize=7)
    plt.text(start_date, 9*(max(var11)-min(var11))/13 + min(var11), u"EcTyp noise = %f"%(ecartType(noise1[s1:e1+1])), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend(bbox_to_anchor =(1, 1), ncol = 2)
    plt.subplot(322)
    plt.plot(sent_at2, noise2, label='bruit 2')
    plt.text(start_date, max(var12), u"min noise = %f"%(min(noise2[s2:e2+1])), fontsize=7)
    plt.text(start_date, 12*(max(var12)-min(var12))/13 + min(var12), u"max noise = %f"%(max(noise2[s2:e2+1])), fontsize=7)
    plt.text(start_date, 11*(max(var12)-min(var12))/13 + min(var12), u"moy noise = %f"%(moyenne(noise2[s2:e2+1])), fontsize=7)
    plt.text(start_date, 10*(max(var12)-min(var12))/13 + min(var12), u"med noise = %f"%(mediane(noise2[s2:e2+1])), fontsize=7)
    plt.text(start_date, 9*(max(var12)-min(var12))/13 + min(var12), u"EcTyp noise = %f"%(ecartType(noise2[s2:e2+1])), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend(bbox_to_anchor =(1, 1), ncol = 2)
    plt.subplot(323)
    plt.plot(sent_at3, noise3, label='bruit 3')
    plt.text(start_date, max(var13), u"min noise = %f"%(min(noise3[s3:e3+1])), fontsize=7)
    plt.text(start_date, 12*(max(var13)-min(var13))/13 + min(var13), u"max noise = %f"%(max(noise3[s3:e3+1])), fontsize=7)
    plt.text(start_date, 11*(max(var13)-min(var13))/13 + min(var13), u"moy noise = %f"%(moyenne(noise3[s3:e3+1])), fontsize=7)
    plt.text(start_date, 10*(max(var13)-min(var13))/13 + min(var13), u"med noise = %f"%(mediane(noise3[s3:e3+1])), fontsize=7)
    plt.text(start_date, 9*(max(var13)-min(var13))/13 + min(var13), u"EcTyp noise = %f"%(ecartType(noise3[s3:e3+1])), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend(bbox_to_anchor =(1, 1), ncol = 2)
    plt.subplot(324)
    plt.plot(sent_at4, noise4, label='bruit 4')
    plt.text(start_date, max(var14), u"min noise = %f"%(min(noise4[s4:e4+1])), fontsize=7)
    plt.text(start_date, 12*(max(var14)-min(var14))/13 + min(var14), u"max noise = %f"%(max(noise4[s4:e4+1])), fontsize=7)
    plt.text(start_date, 11*(max(var14)-min(var14))/13 + min(var14), u"moy noise = %f"%(moyenne(noise4[s4:e4+1])), fontsize=7)
    plt.text(start_date, 10*(max(var14)-min(var14))/13 + min(var14), u"med noise = %f"%(mediane(noise4[s4:e4+1])), fontsize=7)
    plt.text(start_date, 9*(max(var14)-min(var14))/13 + min(var14), u"EcTyp noise = %f"%(ecartType(noise4[s4:e4+1])), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend(bbox_to_anchor =(1, 1), ncol = 2)
    plt.subplot(325)
    plt.plot(sent_at5, noise5, label='bruit 5')
    plt.text(start_date, max(var15), u"min noise = %f"%(min(noise5[s5:e5+1])), fontsize=7)
    plt.text(start_date, 12*(max(var15)-min(var15))/13 + min(var15), u"max noise = %f"%(max(noise5[s5:e5+1])), fontsize=7)
    plt.text(start_date, 11*(max(var15)-min(var15))/13 + min(var15), u"moy noise = %f"%(moyenne(noise5[s5:e5+1])), fontsize=7)
    plt.text(start_date, 10*(max(var15)-min(var15))/13 + min(var15), u"med noise = %f"%(mediane(noise5[s5:e5+1])), fontsize=7)
    plt.text(start_date, 9*(max(var15)-min(var15))/13 + min(var15), u"EcTyp noise = %f"%(ecartType(noise5[s5:e5+1])), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend(bbox_to_anchor =(1, 1), ncol = 2)
    plt.subplot(326)
    plt.plot(sent_at6, noise6, label='noise 6')
    plt.text(start_date, max(var16), u"min noise = %f"%(min(noise6[s6:e6+1])), fontsize=7)
    plt.text(start_date, 12*(max(var16)-min(var16))/13 + min(var16), u"max noise = %f"%(max(noise6[s6:e6+1])), fontsize=7)
    plt.text(start_date, 11*(max(var16)-min(var16))/13 + min(var16), u"moy noise = %f"%(moyenne(noise6[s6:e6+1])), fontsize=7)
    plt.text(start_date, 10*(max(var16)-min(var16))/13 + min(var16), u"med noise = %f"%(mediane(noise6[s6:e6+1])), fontsize=7)
    plt.text(start_date, 9*(max(var16)-min(var16))/13 + min(var16), u"EcTyp noise = %f"%(ecartType(noise6[s6:e6+1])), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend(bbox_to_anchor =(1, 1), ncol = 2)
    plt.show()
elif variable1 == 'Humidité' or variable1 == 'humidité' or variable1 == 'Humidite' or variable1 == 'humidite' :
    ...
    plt.text(start_date, max(var11), u"min humidity = %f"%(min(humidity1[s1:e1+1])), fontsize=7)
    plt.text(start_date, 12*(max(var11)-min(var11))/13 + min(var11), u"max humidity = %f"%(max(humidity1[s1:e1+1])), fontsize=7)
    plt.text(start_date, 11*(max(var11)-min(var11))/13 + min(var11), u"moy humidity = %f"%(moyenne(humidity1[s1:e1+1])), fontsize=7)
    plt.text(start_date, 10*(max(var11)-min(var11))/13 + min(var11), u"med humidity = %f"%(mediane(humidity1[s1:e1+1])), fontsize=7)
    plt.text(start_date, 9*(max(var11)-min(var11))/13 + min(var11), u"EcTyp humidity = %f"%(ecartType(humidity1[s1:e1+1])), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend(bbox_to_anchor =(1, 1), ncol = 2)
    plt.subplot(322)
    plt.plot(sent_at2, humidity2, label='hum 2')
    plt.text(start_date, max(var12), u"min humidity = %f"%(min(humidity2[s2:e2+1])), fontsize=7)
    plt.text(start_date, 12*(max(var12)-min(var12))/13 + min(var12), u"max humidity = %f"%(max(humidity2[s2:e2+1])), fontsize=7)
    plt.text(start_date, 11*(max(var12)-min(var12))/13 + min(var12), u"moy humidity = %f"%(moyenne(humidity2[s2:e2+1])), fontsize=7)
    plt.text(start_date, 10*(max(var12)-min(var12))/13 + min(var12), u"med humidity = %f"%(mediane(humidity2[s2:e2+1])), fontsize=7)
    plt.text(start_date, 9*(max(var12)-min(var12))/13 + min(var12), u"EcTyp humidity = %f"%(ecartType(humidity2[s2:e2+1])), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend(bbox_to_anchor =(1, 1), ncol = 2)
    plt.subplot(323)
    plt.plot(sent_at3, humidity3, label='hum 3')
    plt.text(start_date, max(var13), u"min humidity = %f"%(min(humidity3[s3:e3+1])), fontsize=7)
    plt.text(start_date, 12*(max(var13)-min(var13))/13 + min(var13), u"max humidity = %f"%(max(humidity3[s3:e3+1])), fontsize=7)
    plt.text(start_date, 11*(max(var13)-min(var13))/13 + min(var13), u"moy humidity = %f"%(moyenne(humidity3[s3:e3+1])), fontsize=7)
    plt.text(start_date, 10*(max(var13)-min(var13))/13 + min(var13), u"med humidity = %f"%(mediane(humidity3[s3:e3+1])), fontsize=7)
    plt.text(start_date, 9*(max(var13)-min(var13))/13 + min(var13), u"EcTyp humidity = %f"%(ecartType(humidity3[s3:e3+1])), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend(bbox_to_anchor =(1, 1), ncol = 2)
    plt.subplot(324)
    plt.plot(sent_at4, humidity4, label='hum 4')
    plt.text(start_date, max(var14), u"min humidity = %f"%(min(humidity4[s4:e4+1])), fontsize=7)
    plt.text(start_date, 12*(max(var14)-min(var14))/13 + min(var14), u"max humidity = %f"%(max(humidity4[s4:e4+1])), fontsize=7)
    plt.text(start_date, 11*(max(var14)-min(var14))/13 + min(var14), u"moy humidity = %f"%(moyenne(humidity4[s4:e4+1])), fontsize=7)
    plt.text(start_date, 10*(max(var14)-min(var14))/13 + min(var14), u"med humidity = %f"%(mediane(humidity4[s4:e4+1])), fontsize=7)
    plt.text(start_date, 9*(max(var14)-min(var14))/13 + min(var14), u"EcTyp humidity = %f"%(ecartType(humidity4[s4:e4+1])), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend(bbox_to_anchor =(1, 1), ncol = 2)
    plt.subplot(325)
    plt.plot(sent_at5, humidity5, label='hum 5')
    plt.text(start_date, max(var15), u"min humidity = %f"%(min(humidity5[s5:e5+1])), fontsize=7)
    plt.text(start_date, 12*(max(var15)-min(var15))/13 + min(var15), u"max humidity = %f"%(max(humidity5[s5:e5+1])), fontsize=7)
    plt.text(start_date, 11*(max(var15)-min(var15))/13 + min(var15), u"moy humidity = %f"%(moyenne(humidity5[s5:e5+1])), fontsize=7)
    plt.text(start_date, 10*(max(var15)-min(var15))/13 + min(var15), u"med humidity = %f"%(mediane(humidity5[s5:e5+1])), fontsize=7)
    plt.text(start_date, 9*(max(var15)-min(var15))/13 + min(var15), u"EcTyp humidity = %f"%(ecartType(humidity5[s5:e5+1])), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend(bbox_to_anchor =(1, 1), ncol = 2)
    plt.subplot(326)
    plt.plot(sent_at6, humidity6, label='hum 6')
    plt.text(start_date, max(var16), u"min humidity = %f"%(min(humidity6[s6:e6+1])), fontsize=7)
    plt.text(start_date, 12*(max(var16)-min(var16))/13 + min(var16), u"max humidity = %f"%(max(humidity6[s6:e6+1])), fontsize=7)
    plt.text(start_date, 11*(max(var16)-min(var16))/13 + min(var16), u"moy humidity = %f"%(moyenne(humidity6[s6:e6+1])), fontsize=7)
    plt.text(start_date, 10*(max(var16)-min(var16))/13 + min(var16), u"med humidity = %f"%(mediane(humidity6[s6:e6+1])), fontsize=7)
    plt.text(start_date, 9*(max(var16)-min(var16))/13 + min(var16), u"EcTyp humidity = %f"%(ecartType(humidity6[s6:e6+1])), fontsize=7)
    plt.xlim(start_date,end_date)
    plt.legend(bbox_to_anchor =(1, 1), ncol = 2)
    plt.show()
elif variable1 == 'Lumière' or variable1 == 'lumière' or variable1 == 'Lumiere' or variable1 == 'lumiere' :
    ...
    plt.legend(bbox_to_anchor =(1, 1), ncol = 2)
    plt.subplot(325)
    plt.plot(sent_at5, humidex5, label='Humidex 5')
...
if variable2 != None :
    if variable2 == 'Temperature' or variable2 == 'temperature' or variable2 == 'Température' or variable2 == 'température':
        ...
        plt.text(start_date, (max(var12)-min(var12))/13 + min(var12), u"coef corr = %f"%coefCorr(var12[s2:e2+1],var22[s2:e2+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(323)
        ...
        plt.text(start_date, (max(var13)-min(var13))/13 + min(var13), u"coef corr = %f"%coefCorr(var13[s3:e3+1],var23[s3:e3+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(324)
        ...
        plt.text(start_date, (max(var14)-min(var14))/13 + min(var14), u"coef corr = %f"%coefCorr(var14[s4:e4+1],var24[s4:e4+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(325)
        ...
        plt.text(start_date, (max(var15)-min(var15))/13 + min(var15), u"coef corr = %f"%coefCorr(var15[s5:e5+1],var25[s5:e5+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(326)
        ...
        plt.text(start_date, (max(var16)-min(var16))/13 + min(var16), u"coef corr = %f"%coefCorr(var16[s6:e6+1],var26[s6:e6+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.show()
    elif variable2 == 'bruit' or variable2 == 'Bruit':
        ...
        plt.text(start_date, 6*(max(var12)-min(var12))/13 + min(var12), u"max noise = %f"%(max(noise2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 5*(max(var12)-min(var12))/13 + min(var12), u"moy noise = %f"%(moyenne(noise2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 4*(max(var12)-min(var12))/13 + min(var12), u"med noise = %f"%(mediane(noise2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 3*(max(var12)-min(var12))/13 + min(var12), u"EcTyp noise = %f"%(ecartType(noise2[s2:e2+1])), fontsize=7)
        plt.text(start_date, (max(var12)-min(var12))/13 + min(var12), u"coef corr = %f"%coefCorr(var12[s2:e2+1],var22[s2:e2+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(323)
        plt.plot(sent_at3, noise3, label='bruit 3')
        plt.text(start_date, 7*(max(var13)-min(var13))/13 + min(var13), u"min noise = %f"%(min(noise3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 6*(max(var13)-min(var13))/13 + min(var13), u"max noise = %f"%(max(noise3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 5*(max(var13)-min(var13))/13 + min(var13), u"moy noise = %f"%(moyenne(noise3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 4*(max(var13)-min(var13))/13 + min(var13), u"med noise = %f"%(mediane(noise3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 3*(max(var13)-min(var13))/13 + min(var13), u"EcTyp noise = %f"%(ecartType(noise3[s3:e3+1])), fontsize=7)
        plt.text(start_date, (max(var13)-min(var13))/13 + min(var13), u"coef corr = %f"%coefCorr(var13[s3:e3+1],var23[s3:e3+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(324)
        plt.plot(sent_at4, noise4, label='bruit 4')
        plt.text(start_date, 7*(max(var14)-min(var14))/13 + min(var14), u"min noise = %f"%(min(noise4[s4:e4+1])), fontsize=7)
        plt.text(start_date, 6*(max(var14)-min(var14))/13 + min(var14), u"max noise = %f"%(max(noise4[s4:e4+1])), fontsize=7)
        plt.text(start_date, 5*(max(var14)-min(var14))/13 + min(var14), u"moy noise = %f"%(moyenne(noise4[s4:e4+1])), fontsize=7)
        plt.text(start_date, 4*(max(var14)-min(var14))/13 + min(var14), u"med noise = %f"%(mediane(noise4[s4:e4+1])), fontsize=7)
        plt.text(start_date, 3*(max(var14)-min(var14))/13 + min(var14), u"EcTyp noise = %f"%(ecartType(noise4[s4:e4+1])), fontsize=7)
        plt.text(start_date, (max(var14)-min(var14))/13 + min(var14), u"coef corr = %f"%coefCorr(var14[s4:e4+1],var24[s4:e4+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(325)
        plt.plot(sent_at5, noise5, label='bruit 5')
        plt.text(start_date, 7*(max(var15)-min(var15))/13 + min(var15), u"min noise = %f"%(min(noise5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 6*(max(var15)-min(var15))/13 + min(var15), u"max noise = %f"%(max(noise5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 5*(max(var15)-min(var15))/13 + min(var15), u"moy noise = %f"%(moyenne(noise5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 4*(max(var15)-min(var15))/13 + min(var15), u"med noise = %f"%(mediane(noise5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 3*(max(var15)-min(var15))/13 + min(var15), u"EcTyp noise = %f"%(ecartType(noise5[s5:e5+1])), fontsize=7)
        plt.text(start_date, (max(var15)-min(var15))/13 + min(var15), u"coef corr = %f"%coefCorr(var15[s5:e5+1],var25[s5:e5+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(326)
        plt.plot(sent_at6, noise6, label='bruit 6')
        plt.text(start_date, 7*(max(var16)-min(var16))/13 + min(var16), u"min noise = %f"%(min(noise6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 6*(max(var16)-min(var16))/13 + min(var16), u"max noise = %f"%(max(noise6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 5*(max(var16)-min(var16))/13 + min(var16), u"moy noise = %f"%(moyenne(noise6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 4*(max(var16)-min(var16))/13 + min(var16), u"med noise = %f"%(mediane(noise6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 3*(max(var16)-min(var16))/13 + min(var16), u"EcTyp noise = %f"%(ecartType(noise6[s6:e6+1])), fontsize=7)
        plt.text(start_date, (max(var16)-min(var16))/13 + min(var16), u"coef corr = %f"%coefCorr(var16[s6:e6+1],var26[s6:e6+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.show()
        ...
        plt.subplot(321)
        plt.plot(sent_at1, humidity1, label='hum 1')
        plt.text(start_date, 7*(max(var11)-min(var11))/13 + min(var11), u"min hum = %f"%(min(humidity1[s1:e1+1])), fontsize=7)
        plt.text(start_date, 6*(max(var11)-min(var11))/13 + min(var11), u"max hum = %f"%(max(humidity1[s1:e1+1])), fontsize=7)
        plt.text(start_date, 5*(max(var11)-min(var11))/13 + min(var11), u"moy hum = %f"%(moyenne(humidity1[s1:e1+1])), fontsize=7)
        plt.text(start_date, 4*(max(var11)-min(var11))/13 + min(var11), u"med hum = %f"%(mediane(humidity1[s1:e1+1])), fontsize=7)
        plt.text(start_date, 3*(max(var11)-min(var11))/13 + min(var11), u"EcTyp hum = %f"%(ecartType(humidity1[s1:e1+1])), fontsize=7)
        plt.text(start_date, (max(var11)-min(var11))/13 + min(var11), u"coef corr = %f"%coefCorr(var11[s1:e1+1],var21[s1:e1+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(322)
        plt.plot(sent_at2, humidity2, label='hum 2')
        plt.text(start_date, 7*(max(var12)-min(var12))/13 + min(var12), u"min hum = %f"%(min(humidity2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 6*(max(var12)-min(var12))/13 + min(var12), u"max hum = %f"%(max(humidity2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 5*(max(var12)-min(var12))/13 + min(var12), u"moy hum = %f"%(moyenne(humidity2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 4*(max(var12)-min(var12))/13 + min(var12), u"med hum = %f"%(mediane(humidity2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 3*(max(var12)-min(var12))/13 + min(var12), u"EcTyp hum = %f"%(ecartType(humidity2[s2:e2+1])), fontsize=7)
        plt.text(start_date, (max(var12)-min(var12))/13 + min(var12), u"coef corr = %f"%coefCorr(var12[s2:e2+1],var22[s2:e2+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(323)
        plt.plot(sent_at3, humidity3, label='hum 3')
        plt.text(start_date, 7*(max(var13)-min(var13))/13 + min(var13), u"min hum = %f"%(min(humidity3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 6*(max(var13)-min(var13))/13 + min(var13), u"max hum = %f"%(max(humidity3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 5*(max(var13)-min(var13))/13 + min(var13), u"moy hum = %f"%(moyenne(humidity3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 4*(max(var13)-min(var13))/13 + min(var13), u"med hum = %f"%(mediane(humidity3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 3*(max(var13)-min(var13))/13 + min(var13), u"EcTyp hum = %f"%(ecartType(humidity3[s3:e3+1])), fontsize=7)
        plt.text(start_date, (max(var13)-min(var13))/13 + min(var13), u"coef corr = %f"%coefCorr(var13[s3:e3+1],var23[s3:e3+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(324)
        plt.plot(sent_at4, humidity4, label='hum 4')
        plt.text(start_date, 7*(max(var14)-min(var14))/13 + min(var14), u"min hum = %f"%(min(humidity4[s4:e4+1])), fontsize=7)
        plt.text(start_date, 6*(max(var14)-min(var14))/13 + min(var14), u"max hum = %f"%(max(humidity4[s4:e4+1])), fontsize=7)
        plt.text(start_date, 5*(max(var14)-min(var14))/13 + min(var14), u"moy hum = %f"%(moyenne(humidity4[s4:e4+1])), fontsize=7)
        plt.text(start_date, 4*(max(var14)-min(var14))/13 + min(var14), u"med hum = %f"%(mediane(humidity4[s4:e4+1])), fontsize=7)
        plt.text(start_date, 3*(max(var14)-min(var14))/13 + min(var14), u"EcTyp hum = %f"%(ecartType(humidity4[s4:e4+1])), fontsize=7)
        plt.text(start_date, (max(var14)-min(var14))/13 + min(var14), u"coef corr = %f"%coefCorr(var14[s4:e4+1],var24[s4:e4+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(325)
        plt.plot(sent_at5, humidity5, label='hum 5')
        plt.text(start_date, 7*(max(var15)-min(var15))/13 + min(var15), u"min hum = %f"%(min(humidity5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 6*(max(var15)-min(var15))/13 + min(var15), u"max hum = %f"%(max(humidity5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 5*(max(var15)-min(var15))/13 + min(var15), u"moy hum = %f"%(moyenne(humidity5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 4*(max(var15)-min(var15))/13 + min(var15), u"med hum = %f"%(mediane(humidity5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 3*(max(var15)-min(var15))/13 + min(var15), u"EcTyp hum = %f"%(ecartType(humidity5[s5:e5+1])), fontsize=7)
        plt.text(start_date, (max(var15)-min(var15))/13 + min(var15), u"coef corr = %f"%coefCorr(var15[s5:e5+1],var25[s5:e5+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(326)
        plt.plot(sent_at6, humidity6, label='hum 6')
        plt.text(start_date, 7*(max(var16)-min(var16))/13 + min(var16), u"min hum = %f"%(min(humidity6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 6*(max(var16)-min(var16))/13 + min(var16), u"max hum = %f"%(moyenne(humidity6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 5*(max(var16)-min(var16))/13 + min(var16), u"moy hum = %f"%(moyenne(humidity6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 4*(max(var16)-min(var16))/13 + min(var16), u"med hum = %f"%(mediane(humidity6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 3*(max(var16)-min(var16))/13 + min(var16), u"EcTyp hum = %f"%(ecartType(humidity6[s6:e6+1])), fontsize=7)
        plt.text(start_date, (max(var16)-min(var16))/13 + min(var16), u"coef corr = %f"%coefCorr(var16[s6:e6+1],var26[s6:e6+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.show()
        ...
        plt.subplot(321)
        plt.plot(sent_at1, lum1, label='lum 1')
        plt.text(start_date, 7*(max(var11)-min(var11))/13 + min(var11), u"min lum = %f"%(min(lum1[s1:e1+1])), fontsize=7)
        plt.text(start_date, 6*(max(var11)-min(var11))/13 + min(var11), u"max lum = %f"%(max(lum1[s1:e1+1])), fontsize=7)
        plt.text(start_date, 5*(max(var11)-min(var11))/13 + min(var11), u"moy lum = %f"%(moyenne(lum1[s1:e1+1])), fontsize=7)
        plt.text(start_date, 4*(max(var11)-min(var11))/13 + min(var11), u"med lum = %f"%(mediane(lum1[s1:e1+1])), fontsize=7)
        plt.text(start_date, 3*(max(var11)-min(var11))/13 + min(var11), u"EcTyp lum = %f"%(ecartType(lum1[s1:e1+1])), fontsize=7)
        plt.text(start_date, (max(var11)-min(var11))/13 + min(var11), u"coef corr = %f"%coefCorr(var11[s1:e1+1],var21[s1:e1+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(322)
        plt.plot(sent_at2, lum2, label='lum 2')
        plt.text(start_date, 7*(max(var12)-min(var12))/13 + min(var12), u"min lum = %f"%(min(lum2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 6*(max(var12)-min(var12))/13 + min(var12), u"max lum = %f"%(max(lum2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 5*(max(var12)-min(var12))/13 + min(var12), u"moy lum = %f"%(moyenne(lum2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 4*(max(var12)-min(var12))/13 + min(var12), u"med lum = %f"%(mediane(lum2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 3*(max(var12)-min(var12))/13 + min(var12), u"EcTyp lum = %f"%(ecartType(lum2[s2:e2+1])), fontsize=7)
        plt.text(start_date, (max(var12)-min(var12))/13 + min(var12), u"coef corr = %f"%coefCorr(var12[s2:e2+1],var22[s2:e2+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(323)
        plt.plot(sent_at3, lum3, label='lum 3')
        plt.text(start_date, 7*(max(var13)-min(var13))/13 + min(var13), u"min lum = %f"%(min(lum3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 6*(max(var13)-min(var13))/13 + min(var13), u"max lum = %f"%(max(lum3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 5*(max(var13)-min(var13))/13 + min(var13), u"moy lum = %f"%(moyenne(lum3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 4*(max(var13)-min(var13))/13 + min(var13), u"med lum = %f"%(mediane(lum3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 3*(max(var13)-min(var13))/13 + min(var13), u"EcTyp lum = %f"%(ecartType(lum3[s3:e3+1])), fontsize=7)
        plt.text(start_date, (max(var13)-min(var13))/13 + min(var13), u"coef corr = %f"%coefCorr(var13[s3:e3+1],var23[s3:e3+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(324)
        plt.plot(sent_at4, lum4, label='lum 4')
        plt.text(start_date, 7*(max(var14)-min(var14))/13 + min(var14), u"min lum = %f"%(min(lum4[s4:e4+1])), fontsize=7)
        plt.text(start_date, 6*(max(var14)-min(var14))/13 + min(var14), u"max lum = %f"%(max(lum4[s4:e4+1])), fontsize=7)
        plt.text(start_date, 5*(max(var14)-min(var14))/13 + min(var14), u"moy lum = %f"%(moyenne(lum4[s4:e4+1])), fontsize=7)
        plt.text(start_date, 4*(max(var14)-min(var14))/13 + min(var14), u"med lum = %f"%(mediane(lum4[s4:e4+1])), fontsize=7)
        plt.text(start_date, 3*(max(var14)-min(var14))/13 + min(var14), u"EcTyp lum = %f"%(ecartType(lum4[s4:e4+1])), fontsize=7)
        plt.text(start_date, (max(var14)-min(var14))/13 + min(var14), u"coef corr = %f"%coefCorr(var14[s4:e4+1],var24[s4:e4+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(325)
        plt.plot(sent_at5, lum5, label='lum 5')
        plt.text(start_date, 7*(max(var15)-min(var15))/13 + min(var15), u"min lum = %f"%(min(lum5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 6*(max(var15)-min(var15))/13 + min(var15), u"max lum = %f"%(max(lum5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 5*(max(var15)-min(var15))/13 + min(var15), u"moy lum = %f"%(moyenne(lum5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 4*(max(var15)-min(var15))/13 + min(var15), u"med lum = %f"%(mediane(lum5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 3*(max(var15)-min(var15))/13 + min(var15), u"EcTyp lum = %f"%(ecartType(lum5[s5:e5+1])), fontsize=7)
        plt.text(start_date, (max(var15)-min(var15))/13 + min(var15), u"coef corr = %f"%coefCorr(var15[s5:e5+1],var25[s5:e5+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(326)
        plt.plot(sent_at6, lum6, label='lum 6')
        plt.text(start_date, 7*(max(var16)-min(var16))/13 + min(var16), u"min lum = %f"%(min(lum6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 6*(max(var16)-min(var16))/13 + min(var16), u"max lum = %f"%(moyenne(lum6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 5*(max(var16)-min(var16))/13 + min(var16), u"moy lum = %f"%(moyenne(lum6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 4*(max(var16)-min(var16))/13 + min(var16), u"med lum = %f"%(mediane(lum6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 3*(max(var16)-min(var16))/13 + min(var16), u"EcTyp lum = %f"%(ecartType(lum6[s6:e6+1])), fontsize=7)
        plt.text(start_date, (max(var16)-min(var16))/13 + min(var16), u"coef corr = %f"%coefCorr(var16[s6:e6+1],var26[s6:e6+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.show()
        ...
        plt.subplot(321)
        plt.plot(sent_at1, co21, label='CO2 1')
        plt.text(start_date, 7*(max(var11)-min(var11))/13 + min(var11), u"min co2 = %f"%(min(co21[s1:e1+1])), fontsize=7)
        plt.text(start_date, 6*(max(var11)-min(var11))/13 + min(var11), u"max co2 = %f"%(max(co21[s1:e1+1])), fontsize=7)
        plt.text(start_date, 5*(max(var11)-min(var11))/13 + min(var11), u"moy co2 = %f"%(moyenne(co21[s1:e1+1])), fontsize=7)
        plt.text(start_date, 4*(max(var11)-min(var11))/13 + min(var11), u"med co2 = %f"%(mediane(co21[s1:e1+1])), fontsize=7)
        plt.text(start_date, 3*(max(var11)-min(var11))/13 + min(var11), u"EcTyp co2 = %f"%(ecartType(co21[s1:e1+1])), fontsize=7)
        plt.text(start_date, (max(var11)-min(var11))/13 + min(var11), u"coef corr = %f"%coefCorr(var11[s1:e1+1],var21[s1:e1+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(322)
        plt.plot(sent_at2, co22, label='CO2 2')
        plt.text(start_date, 7*(max(var12)-min(var12))/13 + min(var12), u"min co2 = %f"%(min(co22[s2:e2+1])), fontsize=7)
        plt.text(start_date, 6*(max(var12)-min(var12))/13 + min(var12), u"max co2 = %f"%(max(co22[s2:e2+1])), fontsize=7)
        plt.text(start_date, 5*(max(var12)-min(var12))/13 + min(var12), u"moy co2 = %f"%(moyenne(co22[s2:e2+1])), fontsize=7)
        plt.text(start_date, 4*(max(var12)-min(var12))/13 + min(var12), u"med co2 = %f"%(mediane(co22[s2:e2+1])), fontsize=7)
        plt.text(start_date, 3*(max(var12)-min(var12))/13 + min(var12), u"EcTyp co2 = %f"%(ecartType(co22[s2:e2+1])), fontsize=7)
        plt.text(start_date, (max(var12)-min(var12))/13 + min(var12), u"coef corr = %f"%coefCorr(var12[s2:e2+1],var22[s2:e2+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(323)
        plt.plot(sent_at3, co23, label='CO2 3')
        plt.text(start_date, 7*(max(var13)-min(var13))/13 + min(var13), u"min co2 = %f"%(min(co23[s3:e3+1])), fontsize=7)
        plt.text(start_date, 6*(max(var13)-min(var13))/13 + min(var13), u"max co2 = %f"%(max(co23[s3:e3+1])), fontsize=7)
        plt.text(start_date, 5*(max(var13)-min(var13))/13 + min(var13), u"moy co2 = %f"%(moyenne(co23[s3:e3+1])), fontsize=7)
        plt.text(start_date, 4*(max(var13)-min(var13))/13 + min(var13), u"med co2 = %f"%(mediane(co23[s3:e3+1])), fontsize=7)
        plt.text(start_date, 3*(max(var13)-min(var13))/13 + min(var13), u"EcTyp co2 = %f"%(ecartType(co23[s3:e3+1])), fontsize=7)
        plt.text(start_date, (max(var13)-min(var13))/13 + min(var13), u"coef corr = %f"%coefCorr(var13[s3:e3+1],var23[s3:e3+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(324)
        plt.plot(sent_at4, co24, label='CO2 4')
        plt.text(start_date, 7*(max(var14)-min(var14))/13 + min(var14), u"min co2 = %f"%(min(co24[s4:e4+1])), fontsize=7)
        plt.text(start_date, 6*(max(var14)-min(var14))/13 + min(var14), u"max co2 = %f"%(max(co24[s4:e4+1])), fontsize=7)
        plt.text(start_date, 5*(max(var14)-min(var14))/13 + min(var14), u"moy co2 = %f"%(moyenne(co24[s4:e4+1])), fontsize=7)
        plt.text(start_date, 4*(max(var14)-min(var14))/13 + min(var14), u"med co2 = %f"%(mediane(co24[s4:e4+1])), fontsize=7)
        plt.text(start_date, 3*(max(var14)-min(var14))/13 + min(var14), u"EcTyp co2 = %f"%(ecartType(co24[s4:e4+1])), fontsize=7)
        plt.text(start_date, (max(var14)-min(var14))/13 + min(var14), u"coef corr = %f"%coefCorr(var14[s4:e4+1],var24[s4:e4+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(325)
        plt.plot(sent_at5, co25, label='CO2 5')
        plt.text(start_date, 7*(max(var15)-min(var15))/13 + min(var15), u"min co2 = %f"%(min(co25[s5:e5+1])), fontsize=7)
        plt.text(start_date, 6*(max(var15)-min(var15))/13 + min(var15), u"max co2 = %f"%(max(co25[s5:e5+1])), fontsize=7)
        plt.text(start_date, 5*(max(var15)-min(var15))/13 + min(var15), u"moy co2 = %f"%(moyenne(co25[s5:e5+1])), fontsize=7)
        plt.text(start_date, 4*(max(var15)-min(var15))/13 + min(var15), u"med co2 = %f"%(mediane(co25[s5:e5+1])), fontsize=7)
        plt.text(start_date, 3*(max(var15)-min(var15))/13 + min(var15), u"EcTyp co2 = %f"%(ecartType(co25[s5:e5+1])), fontsize=7)
        plt.text(start_date, (max(var15)-min(var15))/13 + min(var15), u"coef corr = %f"%coefCorr(var15[s5:e5+1],var25[s5:e5+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(326)
        plt.plot(sent_at6, co26, label='CO2 6')
        plt.text(start_date, 7*(max(var16)-min(var16))/13 + min(var16), u"min co2 = %f"%(min(co26[s6:e6+1])), fontsize=7)
        plt.text(start_date, 6*(max(var16)-min(var16))/13 + min(var16), u"max co2 = %f"%(moyenne(co26[s6:e6+1])), fontsize=7)
        plt.text(start_date, 5*(max(var16)-min(var16))/13 + min(var16), u"moy co2 = %f"%(moyenne(co26[s6:e6+1])), fontsize=7)
        plt.text(start_date, 4*(max(var16)-min(var16))/13 + min(var16), u"med co2 = %f"%(mediane(co26[s6:e6+1])), fontsize=7)
        plt.text(start_date, 3*(max(var16)-min(var16))/13 + min(var16), u"EcTyp co2 = %f"%(ecartType(co26[s6:e6+1])), fontsize=7)
        plt.text(start_date, (max(var16)-min(var16))/13 + min(var16), u"coef corr = %f"%coefCorr(var16[s6:e6+1],var26[s6:e6+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.show()
        ...
        plt.subplot(321)
        plt.plot(sent_at1, humidex1, label='Humidex 1')
        plt.text(start_date, 7*(max(var11)-min(var11))/13 + min(var11), u"min humidex = %f"%(min(humidex1[s1:e1+1])), fontsize=7)
        plt.text(start_date, 6*(max(var11)-min(var11))/13 + min(var11), u"max humidex = %f"%(max(humidex1[s1:e1+1])), fontsize=7)
        plt.text(start_date, 5*(max(var11)-min(var11))/13 + min(var11), u"moy humidex = %f"%(moyenne(humidex1[s1:e1+1])), fontsize=7)
        plt.text(start_date, 4*(max(var11)-min(var11))/13 + min(var11), u"med humidex = %f"%(mediane(humidex1[s1:e1+1])), fontsize=7)
        plt.text(start_date, 3*(max(var11)-min(var11))/13 + min(var11), u"EcTyp humidex = %f"%(ecartType(humidex1[s1:e1+1])), fontsize=7)
        plt.text(start_date, (max(var11)-min(var11))/13 + min(var11), u"coef corr = %f"%coefCorr(var11[s1:e1+1],var21[s1:e1+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(322)
        plt.plot(sent_at2, humidex2, label='Humidex 2')
        plt.text(start_date, 7*(max(var12)-min(var12))/13 + min(var12), u"min humidex = %f"%(min(humidex2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 6*(max(var12)-min(var12))/13 + min(var12), u"max humidex = %f"%(max(humidex2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 5*(max(var12)-min(var12))/13 + min(var12), u"moy humidex = %f"%(moyenne(humidex2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 4*(max(var12)-min(var12))/13 + min(var12), u"med humidex = %f"%(mediane(humidex2[s2:e2+1])), fontsize=7)
        plt.text(start_date, 3*(max(var12)-min(var12))/13 + min(var12), u"EcTyp humidex = %f"%(ecartType(humidex2[s2:e2+1])), fontsize=7)
        plt.text(start_date, (max(var12)-min(var12))/13 + min(var12), u"coef corr = %f"%coefCorr(var12[s2:e2+1],var22[s2:e2+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(323)
        plt.plot(sent_at3, humidex3, label='Humidex 3')
        plt.text(start_date, 7*(max(var13)-min(var13))/13 + min(var13), u"min humidex = %f"%(min(humidex3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 6*(max(var13)-min(var13))/13 + min(var13), u"max humidex = %f"%(max(humidex3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 5*(max(var13)-min(var13))/13 + min(var13), u"moy humidex = %f"%(moyenne(humidex3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 4*(max(var13)-min(var13))/13 + min(var13), u"med humidex = %f"%(mediane(humidex3[s3:e3+1])), fontsize=7)
        plt.text(start_date, 3*(max(var13)-min(var13))/13 + min(var13), u"EcTyp humidex = %f"%(ecartType(humidex3[s3:e3+1])), fontsize=7)
        plt.text(start_date, (max(var13)-min(var13))/13 + min(var13), u"coef corr = %f"%coefCorr(var13[s3:e3+1],var23[s3:e3+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(324)
        plt.plot(sent_at4, humidex4, label='Humidex 4')
        plt.text(start_date, 7*(max(var14)-min(var14))/13 + min(var14), u"min humidex = %f"%(min(humidex4[s4:e4+1])), fontsize=7)
        plt.text(start_date, 6*(max(var14)-min(var14))/13 + min(var14), u"max humidex = %f"%(max(humidex4[s4:e4+1])), fontsize=7)
        plt.text(start_date, 5*(max(var14)-min(var14))/13 + min(var14), u"moy humidex = %f"%(moyenne(humidex4[s4:e4+1])), fontsize=7)
        plt.text(start_date, 4*(max(var14)-min(var14))/13 + min(var14), u"med humidex = %f"%(mediane(humidex4[s4:e4+1])), fontsize=7)
        plt.text(start_date, 3*(max(var14)-min(var14))/13 + min(var14), u"EcTyp humidex = %f"%(ecartType(humidex4[s4:e4+1])), fontsize=7)
        plt.text(start_date, (max(var14)-min(var14))/13 + min(var14), u"coef corr = %f"%coefCorr(var14[s4:e4+1],var24[s4:e4+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(325)
        plt.plot(sent_at5, humidex5, label='Humidex 5')
        plt.text(start_date, 7*(max(var15)-min(var15))/13 + min(var15), u"min humidex = %f"%(min(humidex5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 6*(max(var15)-min(var15))/13 + min(var15), u"max humidex = %f"%(max(humidex5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 5*(max(var15)-min(var15))/13 + min(var15), u"moy humidex = %f"%(moyenne(humidex5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 4*(max(var15)-min(var15))/13 + min(var15), u"med humidex = %f"%(mediane(humidex5[s5:e5+1])), fontsize=7)
        plt.text(start_date, 3*(max(var15)-min(var15))/13 + min(var15), u"EcTyp humidex = %f"%(ecartType(humidex5[s5:e5+1])), fontsize=7)
        plt.text(start_date, (max(var15)-min(var15))/13 + min(var15), u"coef corr = %f"%coefCorr(var15[s5:e5+1],var25[s5:e5+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.subplot(326)
        plt.plot(sent_at6, humidex6, label='Humidex 6')
        plt.text(start_date, 7*(max(var16)-min(var16))/13 + min(var16), u"min humidex = %f"%(min(humidex6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 6*(max(var16)-min(var16))/13 + min(var16), u"max humidex = %f"%(moyenne(humidex6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 5*(max(var16)-min(var16))/13 + min(var16), u"moy humidex = %f"%(moyenne(humidex6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 4*(max(var16)-min(var16))/13 + min(var16), u"med humidex = %f"%(mediane(humidex6[s6:e6+1])), fontsize=7)
        plt.text(start_date, 3*(max(var16)-min(var16))/13 + min(var16), u"EcTyp humidex = %f"%(ecartType(humidex6[s6:e6+1])), fontsize=7)
        plt.text(start_date, (max(var16)-min(var16))/13 + min(var16), u"coef corr = %f"%coefCorr(var16[s6:e6+1],var26[s6:e6+1]), fontsize=7)
        plt.xlim(start_date,end_date)
        plt.legend(bbox_to_anchor =(0.5, 1), ncol = 2)
        plt.show()
